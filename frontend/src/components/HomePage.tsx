...
function HomePage() {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Sidebar */}
      <aside 
        className={`${isSidebarCollapsed ? 'w-20' : 'w-64'} bg-red-700 shadow-lg transition-all duration-300 ease-in-out`}
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col items-center space-y-4">
            <img
              ...
              alt="User profile"
              className={`${isSidebarCollapsed ? 'w-12 h-12' : 'w-24 h-24'} rounded-full border-4 border-white shadow-md transition-all duration-300`}
            />
            {!isSidebarCollapsed && (
